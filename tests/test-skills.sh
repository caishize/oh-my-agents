...
# --- Required skills ---
EXPECTED_SKILLS="harness-init legibility-score spec-to-task verify encode-mistake arch-guard taste-encoder entropy-sweep harness-review harness-dashboard harness-metrics"
